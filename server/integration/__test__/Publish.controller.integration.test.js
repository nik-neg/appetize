...
describe('integration test of publish controller - publishDish', () => {
  ...
  test.skip('should return 201, because no error occured', async () => {
    const createResult = await request.post('/register')
      .send({
        firstName: 'firstName',
        lastName: 'lastName',
...
//       .expect(500);
//   });
//   test.skip('should return 409, because user could not be found', async () => {
//     sandbox.stub(User, 'findOne').returns(null);
//     const id = 123;
//     await request.get(`/profile/${id}/dashboard`)
//       .send()
...
//       .expect(409);
//   });
//   test.skip('should return 409, because the user didn\'t set the zip code', async () => {
//     const createResult = await request.post('/register')
//       .send({
//         firstName: 'firstName',
//         lastName: 'lastName',
...
//       .expect(409);
//   });
//   test.skip('should return 500, because axios has errored during the request', async () => {
...
//       .expect(500);
//   });
//   test.skip('should return 404, because axios respond with an error', async () => {
//     const createResult = await request.post('/register')
//       .send({
//         firstName: 'firstName',
//         lastName: 'lastName',
...
//       .expect(404);
//   });
//   test.skip('should return 500, because of internal server error in the helper method', async () => {
...
//       .expect(500);
//   });
//   test.skip('should return 200, because they are no errors with the api and database requests', async () => {
//     const createResult = await request.post('/register')
//       .send({
//         firstName: 'firstName',
//         lastName: 'lastName',
